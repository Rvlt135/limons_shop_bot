...
🤖 Я бот-магазин "Лимоны" по продаже товаров любой категории.
...
❓ Возникли вопросы? Не проблема! Команда /sos поможет связаться с админами, которые постараются как можно быстрее 
                                                                                                откликнуться.'''
                         , reply_markup=markup)
